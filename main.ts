...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    shot01 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.shoot)
    mySprite.setPosition(playerPosX, playerPosY)
})
let enemy01: Sprite = null
let spawnSpeed = 0
let shot01: Sprite = null
...
forever(function () {
    music.play(music.createSong(assets.song`Song1`), music.PlaybackMode.UntilDone)
})
forever(function () {
    spawnSpeed = 1000
    enemy01 = sprites.create(img`
        ...
        ................................
        `, SpriteKind.Enemy)
    enemy01.setPosition(0, randint(0, 120))
    enemy01.setVelocity(50, 0)
    pause(2000)
})
